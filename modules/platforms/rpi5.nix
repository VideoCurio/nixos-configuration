...
let
  nixos-hardware = builtins.fetchTarball {
    url =
      "https://github.com/NixOS/nixos-hardware/archive/24cfdc1f9344b90a1eee329a3906e2f39f4d0f1e.tar.gz";
    sha256 = "17gwblxra805sw0w6pmpw8znyh512d8f85ggpkqaxifriskcbgxw";
  };
in { config, pkgs, lib, ... }:
